        ...
        <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
          <div className="space-y-3">
            <div className="flex flex-wrap items-center gap-2">
              <span className={`inline-flex items-center rounded-md px-2.5 py-1 text-xs font-bold uppercase tracking-wider ${isExcluida ? "bg-red-100 text-red-600 dark:bg-red-900/50 dark:text-red-400" : "bg-indigo-100 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-400"}`}>
                {acao.codigo_acao}
              </span>
      ...
      <div className="rounded-2xl border border-border bg-background-card p-6 shadow-sm">
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            {anosRange.length === 0 ? (
              ...
              <div className="space-y-6">
                ...
                {/* Total Geral */}
                <div className="flex items-center justify-between rounded-xl bg-indigo-50 border border-indigo-100 dark:bg-indigo-950/30 dark:border-indigo-900/50 p-6">
                  <span className="text-sm font-bold uppercase tracking-wider text-indigo-700 dark:text-indigo-400">
                    Orçamento Total Estimado
                  </span>
                  <span className="text-xl font-extrabold text-indigo-800 dark:text-indigo-300">
        ...
        {activeTab === "historico" && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            <div className="relative border-l-2 border-indigo-200 dark:border-indigo-900 ml-3 space-y-8 py-2">
              {/* Inclusão */}
              <div className="relative pl-6">
                <span className="absolute -left-[9px] top-1 h-4 w-4 rounded-full border-2 border-white bg-indigo-500 dark:border-slate-900" />
