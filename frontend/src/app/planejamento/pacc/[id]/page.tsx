        ...
        <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
          <div className="space-y-3">
            <div className="flex flex-wrap items-center gap-2">
              <span className={`inline-flex items-center rounded-md px-2.5 py-1 text-xs font-bold uppercase tracking-wider ${isExcluido ? "bg-red-100 text-red-600 dark:bg-red-900/50 dark:text-red-400" : "bg-brand-primary/10 text-brand-primary"}`}>
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div className="flex items-center justify-between border-b border-border pb-4">
              ...
              <Link
                ...
                className="flex items-center gap-1.5 text-xs font-semibold text-brand-primary hover:text-brand-primary-hover hover:underline"
              >
            ...
            {acaoPdtic ? (
              <div className="rounded-xl border border-brand-primary/20 bg-white p-6 shadow-sm dark:border-brand-primary/30 dark:bg-slate-900/50">
                <div className="mb-6 flex items-start justify-between">
                  <div>
                    <div className="flex items-center gap-3">
                      <span className="inline-flex items-center rounded-md bg-brand-primary/10 px-3 py-1 text-sm font-bold uppercase tracking-wider text-brand-primary">
